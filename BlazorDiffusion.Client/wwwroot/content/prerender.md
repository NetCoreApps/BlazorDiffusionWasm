...
[Header](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Client/Shared/Header.razor),
[Sidebar](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Client/Shared/Sidebar.razor) and
[MainLayout](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Client/Shared/MainLayout.razor) 
and paste it into 
[/wwwroot/index.html](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Client/wwwroot/index.html)
...
[PrerenderTasks.cs](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Tests/PrerenderTasks.cs)
with the `prerender` Test category. The only configuration the tasks require is the location of the `ClientDir` WASM Project 
defined in [appsettings.json](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Tests/appsettings.json) 
...
[<Loading/>](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Client/Shared/Loading.razor) component
...
[Docs.razor](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Client/Pages/Docs.razor).
...
[content](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BlazorDiffusion.Client/wwwroot/content)
directory and uses the same
[/BlazorDiffusion.Client/MarkdownUtils.cs](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Client/MarkdownUtils.cs)
implementation [Docs.razor](https://github.com/NetCoreTemplates/blazor-tailwind/blob/main/BlazorDiffusion.Client/Pages/Docs.razor)
